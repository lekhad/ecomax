...
@section('content')
    ...
    <section id="cart_items">
        <div class="container">
            ...
            <div class="table-responsive cart_info">
                <table class="table table-condensed">
                    ...
                    <tr>
                        ...
                        <td class="cart_total">
                            <p class="cart_total_price">N {{ $cart->price* $cart->quantity }}</p>
                        </td>
                    </tr>
                        ...
                        <td colspan="2">
                            <table class="table table-condensed total-result">
                                ...
                                <tr class="shipping-cost">
                                    ...
                                    {{--The Coupon Amount is Coming from the ApplyCoupon in ProductsController--}}
                                ...
                                <tr>
                                    <td>Grand Total</td>
                                    <td><span>N {{ $grand_total= $total_amount - Session::get('CouponAmount') }}</span></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <form  id="paymentForm" action="{{ url('/place-order') }}" method="post">
                {{ csrf_field() }}
