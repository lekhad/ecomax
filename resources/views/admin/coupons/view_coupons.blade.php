                                ...
                                @foreach($coupons as $coupon)
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            <a <?php /* onclick="return delCoupon();" href="{{ url('/admin/delete-coupon/'.$coupon->id) }}" */?>  rel=" {{ $coupon->id }} " rel1="delete-coupon" href="javascript:" class="btn btn-danger btn-mini deleteRecord" title="Delete Coupon">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
