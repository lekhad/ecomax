                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed">
                            ...
                            <tr>
                                ...
                                <td class="text-center">N {{ $pro->product_price }}</td>
                                <td class="text-center">{{ $pro->product_qty }}</td>
                                <td class="text-right">N {{ $pro->product_price * $pro->product_qty }}</td>
                            ...
                            <tr>
                                ...
                                <td class="thick-line text-right">N {{ $subtotal }}</td>
                            </tr>
                            <tr>
                                <td class="no-line"></td>
                                <td class="no-line"></td>
                                ...
                                <td class="no-line text-right">N {{ $orderDetails->shipping_charges }}</td>
                            </tr>
                            <tr>
                                <td class="no-line"></td>
                                <td class="no-line"></td>
                                ...
                                <td class="no-line text-right">N {{ $orderDetails->coupon_amount }}</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="no-line text-right">N {{ $orderDetails->grand_total }}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
