            ...
            <div class="row">
                <div class="col-sm-12">
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        {{--Dynamic way of displaying the banner--}}
                        <div class="carousel-inner">
                            @foreach($banners as $key=> $banner)
                                <div class="item @if($key==0) active @endif">
                                  <a href="{{ $banner->link }}">
                                    <img src="images/frontend_images/banners/{{ $banner->image }}" alt=""/>
                                 </a>
                                </div>
                            @endforeach
                        </div>
                        ...
                        {{--Static display of the banner to the homepage--}}
                        {{--<div class="carousel-inner">--}}
                    ...
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group category-products" id="accordian">
                            ...
                            <div class="panel panel-default">
                                     ...
                                     {{--This works with the first method in IndexController and use php echo --}}
{{--                                     echo $categories_menu;--}}

                              {{--Second Method to display the list of categories and subcategories--}}
